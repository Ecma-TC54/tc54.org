            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    ...
                    <div className="card">
                        <div className="card-container">
                            <h3>Standards</h3>
                            <p>OWASP and Ecma TC are actively working on standardizing CycloneDX v1.6. Ecma standards of CycloneDX should be available in 2024 and will be listed here.</p>
                        </div>
                    </div>
                </div>
            </div>
